...
<head>
    ...
    <title>Nueva remisión — {{ $obra->nombre }}</title>
...
<main class="page">
    ...
    <div class="page-header">
        ...
        <div class="page-heading">Nueva remisión</div>
    ...
    <form method="POST" action="{{ route('remisiones.store', $obra) }}" id="form-remision">
        @csrf
