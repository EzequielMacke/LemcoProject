...
<head>
    ...
    <style>
        ...
        .header-label { font-size: 11px; font-weight: bold; color: #c7d2fe; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px; }
        ...
        .data-label { font-size: 11px; font-weight: bold; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px; min-width: 90px; padding-top: 1px; }
...
<div class="wrap">
    <div class="header">
        <div class="header-label">Recepción de probetas</div>
        <div class="header-title">Remisión {{ $remision->nro }}</div>
    </div>
    <div class="body">
        <p>Se adjunta la ficha de recepción de probetas con los siguientes datos:</p>
        ...
        <div class="data-row">
            <span class="data-label">Contratista</span>
            <span class="data-value">{{ $remision->contratista }}</span>
        </div>
        <div class="data-row">
            <span class="data-label">Fecha</span>
            <span class="data-value">{{ $remision->created_at->format('d/m/Y') }}</span>
        </div>
        <div class="data-row">
            <span class="data-label">Probetas</span>
            <span class="data-value">{{ $remision->probetas->count() }}</span>
        </div>

        <hr class="divider">
        <p style="font-size:12px; color:#6b7280;">El PDF con el detalle completo se encuentra adjunto a este correo.</p>
    </div>
